...
function AGP({ lang, navigate }) {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: ko ? "단일 입금 최소는 1g(현재 시세로 약 USD 153 / KRW 210,000 수준)입니다. 월간 자동이체 최소는 KRW 200,000부터 설정 가능합니다." : "The minimum single purchase is 1 gram (~USD 153 / KRW 210,000 at current spot). The minimum monthly auto-debit is KRW 200,000."
    },
    {
